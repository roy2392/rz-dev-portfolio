...
describe('ProjectsSection', () => {
  ...
  it('renders repositories', () => {
    ...
    expect(links[0].closest('a')).toHaveAttribute('href', 'https://github.com/roy2392/test-repo-1');
    expect(links[1].closest('a')).toHaveAttribute('href', 'https://github.com/roy2392/test-repo-2');
  });
  ...
  it('calls useGithubRepos with correct parameters', () => {
    ...
    expect(useGithubRepos).toHaveBeenCalledWith('roy2392', 6);
  });
}); 