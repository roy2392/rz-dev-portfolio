...
import { Star, GitBranch, ArrowUpRight, Brain, Server, Database, Bot, Cloud, Cpu, ExternalLink } from 'lucide-react'
...
export const HomeSection = () => {
  ...
  const openWindowIds = Object.entries(windows).filter(([, v]) => v).map(([k]) => k)
  ...
  return (
    <>
      ...
      {booted && (
        <>
          {/* ── Desktop Widgets (left side, like reference) ── */}
