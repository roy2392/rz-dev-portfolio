...
export const MacWindow = ({
  ...
  return (
    <motion.div
      ...
      className="flex flex-col rounded-xl overflow-hidden shadow-2xl shadow-black/40"
    >
      {/* Title Bar */}
      <div className="h-12 bg-[#2D2D2D]/95 backdrop-blur-sm flex items-center px-4 relative cursor-grab active:cursor-grabbing flex-shrink-0 border-b border-white/5">
